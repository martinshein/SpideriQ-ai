---
name: directory
description: "Build /directory/{category}/{city}/{listing} pages programmatically: create category → bulk-upsert listings (or import from IDAP) → deploy. Use for SEO directories with thousands of generated pages."
---
# recipes/directory
